...
<ul>
   ...
   <li class="last"><a href='control.php'><span>Input Control User</span></a></li>
   <li class="last"><a href='daftar_user.php'><span>Daftar Control User</span></a></li>
   <li><a href="edit_admin.php?username=<?php echo $_SESSION['MM_Username']; ?>"><span>Edit Admin</span></a></li>
   </ul>
   </li>
   <?php } ?>
   
   <?php if($_SESSION['MM_UserGroup']=="control_user") { ?>
   <li><a href="edit_user.php?username=<?php echo $_SESSION['MM_Username']; ?>"><span>Edit Control User</span></a></li>
   <?php } ?>
