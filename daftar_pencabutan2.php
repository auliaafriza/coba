...
<table width="100%" border="1" cellpadding="5" cellspacing="0">
  <tr>
    ...
    <td width="115" align="left" bgcolor="#D5ECF7"><strong>Edit</strong></td>
    <td width="100" align="left" bgcolor="#D5ECF7"><strong>Delete</strong></td>
  </tr>
  <tr>
    <td><?php echo $row_pencabutan['no_reg']; ?></td>
    <td><?php echo $row_pencabutan['tgl_pencabutan']; ?></td>
    <td><a href="edit_pencabutan.php?id=<?php echo $row_pencabutan['id']; ?>">Edit</a></td>
    <td><a href="delete_pencabutan.php?id=<?php echo $row_pencabutan['id']; ?>" onclick="return confirm('hapus data  <?php echo $row_pencabutan['id']; ?>?')">Delete</a></td>
  </tr>
</table>
</body>
</html>
